 ...
 * @since       11.1
 */
class JFormRuleLimit extends JFormRule
{
	/**
	...
	public function test(&$element, $value, $group = null, &$input = null, &$form = null)
	{
		...
		return new JException(JText::sprintf('%s cannot be longer than %s characters. You entered %s characters.', $label, $limit, $length));
	}
}
